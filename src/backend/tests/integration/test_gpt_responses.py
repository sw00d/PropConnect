...
from conversations.utils import init_conversation_util, get_vendor_from_conversation
from tests.utils import CkcAPITestCase
from unittest.mock import patch


class TestGPT(CkcAPITestCase):
    ...
    def test_vendor_detection_handyman(self):
        # Handyman
        Message.objects.create(message_content='My cabinet door is jammed.', role="user", conversation=self.conversation)
